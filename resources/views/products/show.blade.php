...
@media (hover:hover) and (pointer:fine){
    ...
    .nav-item:hover::after{ background-color: var(--orange-clr); }
}
...
<br><br><br>
  <main>
 <center> <h1 style="font-size:70px;"> Product Details</h1></center>
    <article class="product">
      <section class="product__slider default-container" aria-label="Product preview">
        ...
        <div class="image-box" aria-label="Product preview" role="region">
          ...
          <img src="{{ asset('storage/' . $product->image) }}" alt="Brown and white sneaker" class="image-box__src" data-product-id="item-cart-1" tabindex="0" aria-controls="lightbox" aria-expanded="false">
</div>
        ...
        <ul class="product__thumbs default-container" aria-label="Product thumbnails">
          <li class="thumb-item">
            <button type="button" class="thumb-item__btn" aria-label="change to image 1">
              <img src="{{$product->image_add2}}" alt="" data-thumb-index="0" role="presentation">
            </button>
          </li>
          <li class="thumb-item">
            <button type="button" class="thumb-item__btn" aria-label="change to image 2">
              <img src="{{$product->image_add2}}" alt="" data-thumb-index="1" role="presentation">
            </button>
          </li>
          <li class="thumb-item">
            <button type="button" class="thumb-item__btn" aria-label="change to image 3">
              <img src="{{$product->image_add3}}" alt="" data-thumb-index="2" role="presentation">
            </button>
          </li>
          <li class="thumb-item">
            <button type="button" class="thumb-item__btn" aria-label="change to image 4">
              <img src="{{$product->image_add2}}" alt="" data-thumb-index="3" role="presentation">
            </button>
          </li>
        </ul>
      </section>
      <section class="product__content default-container" aria-label="Product content">
        <br> <br>
        <header>
          <h2 class="company-name" tabindex="0">PRIMAPOI</h2>
        ...
        <div class="product__price">
          <div class="discount-price">
            <p class="discount-price__value" tabindex="0">
               {{ $product->price - $product->discount }} TND
              <span class="sr-only">dolars</span>
            </p>
            <p class="discount-price__discount" tabindex="0">-{{ $product-> discount }}TND</p>
          </div>
        ...
        <div class="cart-form">
  <div class="cart-form__input-container">
    <button class="btn-changeValue btn-minus">
      <i class="icon icon-minus"></i>
    </button>
    <input type="number" id="product__quantity" value="1" min="1">
    <button class="btn-changeValue btn-plus">
      <i class="icon icon-plus"></i>
    </button>
  </div>
 <button class="cart-form__add-btn" id="open-popup-btn" onclick="initialisepopup()">
...
function initializeQuantityControls() {
    ...
    const decrementButton = document.querySelector('.btn-minus');
    const incrementButton = document.querySelector('.btn-plus');
